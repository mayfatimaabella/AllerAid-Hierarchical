     ...
     */
      async saveEditedEmergencyMessage(
        ...
        const profileUpdates: Partial<UserProfile> = {
          fullName: message.name || userProfile.fullName || '',
        ...
        await this.userService.updateUserProfile(uid, profileUpdates);

        // Optimistic update — includes instructions for UI display even though
        // it's not part of the EmergencyMessage Firestore interface
